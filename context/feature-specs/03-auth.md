Clerk is already installed and connected. Wire it into the Next.js app: provider, auth page, redirect, route protection, and user menu.
...
Crate sign-in and sign-up pages using Clerk components
