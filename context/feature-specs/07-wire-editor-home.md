...
Create a gook in `hooks/` that manages dialog state and project mutations.
...
- slugify he name to create the room ID
- call `POST /api/projects`
- navigate to the new workspace

The project ID and Liveblocks room ID shoud stay aligned.
...
Connet the hook to the sidebar and dialogs.
